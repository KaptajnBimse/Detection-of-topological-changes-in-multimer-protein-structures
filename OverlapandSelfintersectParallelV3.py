...
P1 = np.loadtxt('Test txt/Omega2a_b/P1.txt')
P2 = np.loadtxt('Test txt/Omega2a_b/P2.txt')
RePar1 = np.loadtxt('Test txt/Omega2a_b/RePar1.txt')
RePar2 = np.loadtxt('Test txt/Omega2a_b/RePar2.txt')
IsAligned = np.loadtxt('Test txt/Omega2a_b/IsAligned.txt')
P1org = np.loadtxt('Test txt/Omega2a_b/P1org.txt')
P2org = np.loadtxt('Test txt/Omega2a_b/P2org.txt')
NresAverage = np.loadtxt('Test txt/Omega2a_b/NresAverage.txt')
