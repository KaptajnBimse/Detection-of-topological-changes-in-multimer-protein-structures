...
def one_PDB_to_seq(PDB_filename):
    ...
    return P1, seq1, chain_com


def two_PDB_to_seq(PDB1_filename, PDB2_filename):

    P1, seq1, chain_com1 = one_PDB_to_seq(PDB1_filename)
    P2, seq2, chain_com2 = one_PDB_to_seq(PDB2_filename)


    if len(seq1) != len(seq2):
        print("The number of chains is different between the two structures")

    return P1, P2, seq1, seq2, chain_com1, chain_com2